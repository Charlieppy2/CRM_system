...
export default function EditFinancialRecord() {
  ...
  useEffect(() => {
    ...
    if (savedRecords) {
      ...
      const record = records.find((r: FinancialRecord) => r._id === recordId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 更新 localStorage 中的記錄
      const savedRecords = localStorage.getItem('financialRecords');
      if (savedRecords) {
        const records = JSON.parse(savedRecords);
        const updatedRecords = records.map((record: FinancialRecord) => 
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">編輯財務記錄</h1>
          <p className="text-gray-600">修改現有的財務記錄</p>
        </div>
